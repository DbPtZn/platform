...
import { LocalUploadFile } from 'src/uploadfile/uploadfile.service'
...
export class BucketService {
  ...
  async uploadFile(file: LocalUploadFile, dirname: string, prv = false) {
    return new Promise((resolve, reject) => {
      this.cos.putObject(
        {
          Bucket: prv ? this.common.privateBucket : this.common.bucket,
          Region: prv ? this.common.privateREGION : this.common.region,
